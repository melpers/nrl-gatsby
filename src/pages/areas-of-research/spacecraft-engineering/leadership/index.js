...
const Index = (props) => {
  ...
  query {
    markdownRemark(
        fileAbsolutePath: {regex: "/pages/areas-of-research/spacecraft-engineering/leadership/"},
        frontmatter: {title: {eq: "Leadership"}}
      ) {
      frontmatter {
        title
        hero_image {
    ...
    >
      ...
      <div className="content-wrapper">
        ...
        <div className="main-column">
          <ul className="tabs">
            <li><Link to="/areas-of-research/spacecraft-engineering">Overview</Link></li>
            <li className="active">Leadership</li>
          </ul>
          ...
          <div className="leadership-bio-block">
            ...
            <div className="leadership-bio-content">
              ...
              <p className="bio-contacts"><span className="bio-contact-label">E</span> <a href="mailto:spaenginfo@nrl.navy.mil">spaenginfo@nrl.navy.mil</a> <span className="bio-contact-label">P</span> (202) 767 6408 <span className="bio-contact-label">F</span> (202) 767 6429</p>
            </div>
          </div>
